 ...
 */
export function setupLoroDebugging(binding: Binding): void {
 ...
 */
export function logTreeStructure(): void {
  if ((window as any).debugLoro?.logStructure) {
    (window as any).debugLoro.logStructure();
  } else {
    console.warn('Debug utilities not initialized. Call setupLoroDebugging first.');
  }
}
 ...
 */
export function verifyTreeStructure(): void {
  if ((window as any).debugLoro?.verifyStructure) {
    (window as any).debugLoro.verifyStructure();
  } else {
    console.warn('Debug utilities not initialized. Call setupLoroDebugging first.');
  }
}
